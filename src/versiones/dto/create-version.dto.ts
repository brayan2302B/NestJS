...
export class CreateVersionDto {
  ...
  @ApiProperty({
    description: 'Descripción de los cambios de la versión',
    required: false,
    example: 'Carga inicial del reporte',
  })
  @IsString()
  @IsOptional()
  @MaxLength(255)
  ...
  @ApiProperty({
    description: 'Estado de la versión (e.g. pendiente, validado, devuelto)',
    default: 'pendiente',
    example: 'pendiente',
  })
  @IsString()
  ...
  @ApiProperty({
    description: 'ID del informe asociado a esta versión',
    example: 1,
  })
  @IsInt()
  @IsOptional()
  ...
  @ApiProperty({
    ...
    required: false,
    example: 'uploads/informes/informe-123.pdf',
  })
  @IsString()
  @IsOptional()
  @MaxLength(255)
