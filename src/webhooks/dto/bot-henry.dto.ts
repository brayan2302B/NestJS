...
export class BotHenryWebhookDto {
  @ApiProperty({
    description: 'Número de documento / Cédula del instructor',
    example: '1098765432',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    ...
    example: 'devuelto',
    enum: ['validado', 'devuelto', 'pendiente'],
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Observaciones de la revisión realizada por la IA',
    example: 'Falta la firma en la página 3',
  })
  @IsString()
  @IsOptional()
  observacion?: string;
